...
export function CreateDialog({ children }: { children: React.ReactNode }) {
  ...
  const handleNewProject = () => {
    ...
    setTimeout(() => setProjectDialogOpen(true), 100);
  };
  ...
  return (
        ...
        <div className="grid gap-4 py-4">
           ...
           >
              ...
              <div className="flex flex-col items-start">
                 ...
                 <span className="text-xs text-muted-foreground font-normal">Create a collection of assets</span>
              </div>
           </Button>
    ...
    {/* Separate dialogs for Create Project and Upload */}
